...
LABEL version="1.0"
LABEL description="This is a PHP-7.4 image with sqlsrv and pdo_sqlsrv extensions along with composer and mssql-tools18. The aim of this image is to provide a easy environment to work with SQLSRV & PDO-SQLSRV extension for PHP & also extending it with whatever the user needs. For more directions, please refer to https://github.com/ShahriarRahat/php74-sqlsrv-composer"
